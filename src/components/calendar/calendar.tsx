...
const MotionCalendarDay = m(CalendarDay);
  ...
  return (
    <LazyMotion features={domAnimation}>
      <MotionCard
        ...
        className="mb-auto w-fit select-none overflow-hidden rounded-lg p-6 font-light shadow-xl">
        ...
        {/* Calendar */}
        {/* === Days === */}
        <CardContent className="borderborder-orange-300 flex flex-row items-start justify-center overflow-hidden rounded-md bg-orange-200 p-1 text-center text-lg font-semibold leading-8">
